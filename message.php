                                        ...
                                        <div class="chat_people">
                                            ...
                                            <div class="chat_ib">
                                                <h5>
                                                    ...
                                                    <span class="chat_date">Space User</span>
                                                </h5>
                ...
                <div class="mesgs">
                            ...
                            if (!mysqli_stmt_prepare($stmt, $sql)) {
                                ...
                                if ($resultCheck === 0) {
                                    ...
                                    if (!mysqli_stmt_prepare($stmt, $sql)) {
                                        ...
                                        // We don't need mysqli_stmt_store_result() here, as we don't fetch rows from this statement.
                    ...
                    <div class="type_msg">
                        <div class="input_msg_write">
                            ...
                            <button id="reply" class="msg_send_btn" type="button"><i class="fa fa-paper-plane-o" aria-hidden="true"></i></button>
                        </div>
                    </div>
                </div>
            </div>
