                        ...
                        <form action="" method="post" name="pollFrm">
                            ...
                            <div class="funkyradio">
                                ...
                                if (!empty($voted)) {
                                    ...
                                    echo '<h1>Results</h1>';
                                    if ($pollResult && isset($pollResult['total_votes'])) {
                                        echo '<b class="text-muted">Total Votes: </b>' . $pollResult['total_votes'] . '<br><br>';
                                        ...
                                        if ($voteCheck && !empty($pollResult['options'])) {
                                            ...
                                            foreach ($pollResult['options'] as $opt => $vote) {
                                                // Check if the option exists in the array before accessing its value
                                                if (array_key_exists($opt, $pollResult['options'])) {
                                ...
                                ?>
                                                    ...
                                                    <div class="line-progress margin-b-20" data-prog-percent="<?php echo $votePercent / 100; ?>">
                                                        <div></div>
                                ...
                                <?php
                                        ...
                                        echo '<p>No results available for this poll.</p>';
                                    }
                                    echo '<br><br>
                                        <a href="./poll-voters.php?poll=' . $_GET['poll'] . '" class="btn btn-secondary">View All Votes</a>
