                ...
                <div class="row">
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade show active" id="forum" role="tabpanel" aria-labelledby="forum-tab">
                                ...
                                <div class="d-flex align-items-center p-3 my-3 text-white-50 bg-purple rounded shadow-sm">
                                    <img class="mr-3" src="img/300.png" alt="" width="48" height="48">
                                  <div class="lh-100">
                    ...
                    <div class="col-sm-2">
                        ...
                        <div class="text-center p-3 mt-5">
                            <a href="https://bio.link/ashishjadhav" target="_blank">
                                <i class="creater-icon fa fa-users fa-5x" aria-hidden="true"></i>
                            </a>
                            <p><br>THE CREATOR</p>
                        </div>

                        <!-- <a href="forum.php" class="btn btn-warning btn-lg btn-block">Orbit Forum</a> -->
                        <a href="hub.php" class="btn btn-secondary btn-lg btn-block">Orbit Hub</a>
                        <br><br><br>
                        ...
                        <a href="create-event.php" class="btn btn-warning btn-lg btn-block">Create a Event</a>
